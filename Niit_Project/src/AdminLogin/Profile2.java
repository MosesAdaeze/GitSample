...
public class Profile2 extends JFrame {
    ...
    public Profile2(){
        ...
        JLabel label = new JLabel("<html>Dr. John Flynn.</html>");
        ...
        label1.setText("   Johnflynn101@gmail.com.");
