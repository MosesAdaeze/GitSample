...
public class Doc_Appointment extends JFrame{
    private JFrame f;
...
//        Add labels.
        ...
        ImageIcon appoint = new ImageIcon("C:\\icon\\medical (1).png");
        appoint.setImage(appoint.getImage());

        JPanel pan = new JPanel();
        pan.setLayout(null);
        pan.setBounds(15,5,230,150);
        pan.setBackground(lor);
        panel3.add(pan);
        ...
        JLabel sch = new JLabel("Scheduled Appointment");
        ...
        f.setIconImage(icon);
        f.setTitle("NIIT CLINIC |  Appointments");
