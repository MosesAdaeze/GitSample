...
public class Profile1 extends JFrame {
    ...
    public Profile1(){
        ...
        JLabel label = new JLabel("<html>Dr. Bradley Whitford.</html>");
        ...
        label1.setText("   whiteford89ley@gmail.com.");
