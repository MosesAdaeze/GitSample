...
public class Contact_Patient extends JFrame{
    private JFrame f;
...
//        Add labels.
        ...
        ImageIcon patient = new ImageIcon("C:\\icon\\viber (1).png");
        patient.setImage(patient.getImage());

        JPanel pan2 = new JPanel();
        pan2.setLayout(null);
        pan2.setBounds(265,5,230,150);
        pan2.setBackground(lor);
        panel3.add(pan2);
        ...
        JLabel sch = new JLabel("Patients Contact");
        ...
        f.setIconImage(icon);
        f.setTitle("NIIT CLINIC |  Contact Patients");
